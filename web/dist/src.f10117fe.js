...
exports.User = User;
},{"./Collection":"src/models/Collection.ts","./Eventing":"src/models/Eventing.ts","./ApiSync":"src/models/ApiSync.ts","./Attributes":"src/models/Attributes.ts","./Model":"src/models/Model.ts"}],"src/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
...
var UserList_1 = require("./views/UserList"); // http://localhost:3000
...
users.fetch();
},{"./models/User":"src/models/User.ts","./models/Collection":"src/models/Collection.ts","./views/UserList":"src/views/UserList.ts"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
